# https://github.com/ZacharyMeng/PolaFormer/blob/main/models/pola_pvt.py
...
class PolaLinearAttention(nn.Module):
    ...
    def forward(self, x, H, W, mode='triton'):
        ...
        if mode == 'torch':
            ...
            x_sim = linear_attention(q_sim, k, v1)
            x_opp = linear_attention(q_opp, k, v2)
        else:
...
if __name__ == "__main__":
    ...
    model = PolaLinearAttention(dim=H*D, num_patches=L, num_heads=H).cuda()
